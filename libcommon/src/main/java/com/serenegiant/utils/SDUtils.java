...
//********************************************************************************
	 ...
	 */
	@TargetApi(Build.VERSION_CODES.KITKAT)
	public static void requestOpenDocument(@NonNull final androidx.fragment.app.Fragment fragment,
		final String mime_type, final int request_code) {
	 ...
	 */
	@TargetApi(Build.VERSION_CODES.KITKAT)
	public static void requestCreateDocument(@NonNull final androidx.fragment.app.Fragment fragment,
		final String mime_type, final int request_code) {
	 ...
	 */
	@TargetApi(Build.VERSION_CODES.LOLLIPOP)
	public static Uri requestStorageAccess(@NonNull final androidx.fragment.app.Fragment fragment,
		final int request_code) {
