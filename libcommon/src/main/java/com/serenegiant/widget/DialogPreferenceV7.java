...
public class DialogPreferenceV7 extends Preference
    ...
    public DialogPreferenceV7(final Context context,
        ...
        final TypedArray a = context.obtainStyledAttributes(attrs, android.R.styleable.DialogPreference, defStyleAttr, defStyleRes);

        mDialogTitle = a.getString(android.R.styleable.DialogPreference_dialogTitle);
        ...
        mDialogMessage = a.getString(
                android.R.styleable.DialogPreference_dialogMessage);
        mDialogIcon = a.getDrawable(
                android.R.styleable.DialogPreference_dialogIcon);
        mPositiveButtonText = a.getString(
                android.R.styleable.DialogPreference_positiveButtonText);
        mNegativeButtonText = a.getString(
                android.R.styleable.DialogPreference_negativeButtonText);
        mDialogLayoutResId = a.getResourceId(
                android.R.styleable.DialogPreference_dialogLayout,
                mDialogLayoutResId);
        a.recycle();
    }
